...
public enum College implements EnumMapperType {
    ...
    BUSINESS_COLLEGE("경영대학", EnumSet.of(Department.BUSINESS,Department.ACCOUNTING, Department.VENTURE_BUSINESS, Department.WELFARE_BUSINESS, Department.SMALL_MEDIUM_BUSINESS, Department.FINANCE, Department.INNOVATION_BUSINESS)),
    ...
    ENGINEERING_COLLEGE("공과대학", EnumSet.of(Department.ENGINEERING,Department.CHEMICAL_ENGINEERING, Department.ELECTRICAL_ENGINEERING, Department.ARCHITECTURE, Department.INDUSTRIAL_SYSTEMS, Department.MECHANICAL_ENGINEERING, Department.MATERIALS_ENGINEERING)),
    ...
    HUMANITIES_COLLEGE("인문대학", EnumSet.of(Department.HUMANITIES,Department.THEOLOGY, Department.KOREAN_LANGUAGE_LITERATURE, Department.ENGLISH_LANGUAGE_LITERATURE, Department.FRENCH_LANGUAGE_LITERATURE, Department.CHINESE_LANGUAGE_LITERATURE, Department.JAPANESE_LANGUAGE_LITERATURE, Department.PHILOSOPHY)),
