...
public enum FavoriteErrorCode implements BaseErrorCode {
    ...
    FAVORITE_NOT_MATCH_USER(HttpStatus.BAD_REQUEST.value(), "FAVORITE_400_3", "즐겨찾기와 유저가 맞지 않습니다"),
    FAVORITE_ALREADY_DELETE(HttpStatus.BAD_REQUEST.value(), "FAVORITE_400_4", "이미 삭제된 즐겨찾기입니다"),
