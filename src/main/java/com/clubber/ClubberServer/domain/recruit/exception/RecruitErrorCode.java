...
public enum RecruitErrorCode implements BaseErrorCode {
    ...
    RECRUIT_UNAUTHORIZED(HttpStatus.UNAUTHORIZED.value(),"RECRUIT_401_!", "모집글 접근 권한이 없습니다."),
    RECRUIT_POST_UNAUTHORIZED(HttpStatus.UNAUTHORIZED.value(),"RECRUIT_401_!", "모집글 작성 권한이 없습니다.");
