...
public enum Faq implements EnumFaqMapperType {
	...
	QUESTION_5("동아리 정보나 해시태그 분류를 수정하고 싶어요", "클러버 공식 인스타그램 (@clubber_ssu)으로 연락 해주시면 빠르게 수정해드릴게요"),
	QUESTION_6("저희 동아리의 정보 게시를 원치 않아요", "클러버 공식 인스타그램 (@clubber_ssu)으로 연락 해주시면 빠르게 조치해드릴게요"),
