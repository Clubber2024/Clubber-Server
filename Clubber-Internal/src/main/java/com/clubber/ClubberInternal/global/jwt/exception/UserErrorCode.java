...
import com.clubber.ClubberInternal.global.exception.BaseErrorCode;
import com.clubber.ClubberInternal.global.exception.ErrorReason;
...
public enum UserErrorCode implements BaseErrorCode {
    ...
    TOKEN_EXPIRED(HttpStatus.UNAUTHORIZED.value(), "USER_401_2", "인증 시간이 만료되었습니다. 인증토큰을 재 발급 해주세요"),
    ACCESS_TOKEN_NOT_EXIST(HttpStatus.UNAUTHORIZED.value(), "USER_401_3", "알맞은 Access Token을 넣어주세요"),
